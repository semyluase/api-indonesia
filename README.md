...
```
GET https://semyluase.github.io/api-indonesia/api/provinces.json
```
...
```
GET https://semyluase.github.io/api-indonesia/api/regencies/{provinceId}.json
```

Contoh untuk mengambil daftar kab/kota di provinsi Aceh (ID = 11):

```
GET https://semyluase.github.io/api-indonesia/api/regencies/11.json
```
...
```
GET https://semyluase.github.io/api-indonesia/api/districts/{regencyId}.json
```

Contoh untuk mengambil daftar kecamatan di Aceh Selatan (ID = 1103):

```
GET https://semyluase.github.io/api-indonesia/api/districts/1103.json
```
...
```
GET https://semyluase.github.io/api-indonesia/api/villages/{districtId}.json
```

Contoh untuk mengambil daftar kelurahan di Trumon (ID = 1103010):

```
GET https://semyluase.github.io/api-indonesia/api/villages/1103010.json
```
